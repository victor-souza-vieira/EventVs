...
insert into pessoa() values (null, "00000000002", "participante1@eventvs.com" ,"Participante1", "$2y$12$v4nbKBU7V5Vz.0yYymbfm.TUvmgXNtMPIdpLtdVRsksPZlCAX/K4G");
insert into pessoa() values (null, "00000000003", "participante2@eventvs.com" ,"Participante2", "$2y$12$v4nbKBU7V5Vz.0yYymbfm.TUvmgXNtMPIdpLtdVRsksPZlCAX/K4G");
insert into pessoa() values (null, "00000000004", "participante3@eventvs.com" ,"Participante3", "$2y$12$v4nbKBU7V5Vz.0yYymbfm.TUvmgXNtMPIdpLtdVRsksPZlCAX/K4G");
insert into pessoa() values (null, "00000000005", "participante4@eventvs.com" ,"Participante4", "$2y$12$v4nbKBU7V5Vz.0yYymbfm.TUvmgXNtMPIdpLtdVRsksPZlCAX/K4G");
insert into participante() values(null, 3);
...
insert into inscricao() values(null, '2021/06/15', 0, 1, 3)
insert into inscricao() values(null, '2021/06/15', 0, 1, 4)
insert into inscricao() values(null, '2021/06/15', 0, 2, 5)
